...
if os.path.exists('/media/dajun/WD3T/sutra/data/dafagu/data_final/output.txt'):
    os.remove('/media/dajun/WD3T/sutra/data/dafagu/data_final/output.txt')
    
    
data_root='/media/dajun/WD3T/sutra/data/dafagu'
extract_to = data_root + '/extracted'

# Open the output file in append mode
i=0
with open('/media/dajun/WD3T/sutra/data/dafagu/data_final/output.txt', 'a') as f:
...
# Read the text file
df = pd.read_csv('/media/dajun/WD3T/sutra/data/dafagu/data_final/output.txt', sep='\t', header=None)

# Write the DataFrame to a CSV file
df.to_csv('/media/dajun/WD3T/sutra/data/dafagu/data_final/output.csv', index=False)